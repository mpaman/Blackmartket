              ...
              >
                <CardContent className="p-6 text-center">
                  ...
                  {/* <p className="text-sm text-gray-500 mt-1">
                    {category.products ? (Array.isArray(category.products) ? category.products.length : 0) : 0} items
                  </p> */}
                </CardContent>
              </Card>
            ))}
              ...
              {products.map((product) => (
                ...
                >
                  ...
                  <CardContent className="p-4">
                    ...
                    {/* No rating/condition, but show category if available */}
                    ...
                    {/* No seller field in backend, so omit */}
                    <Button
